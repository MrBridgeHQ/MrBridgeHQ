<div align="center">
  <img src="https://mr-bridge.com/images/logo.webp" alt="MrBridge" width="120" height="120" style="border-radius: 24px;" />

  <h1>MrBridge</h1>

  <p><strong>We bridge Data and Intelligence.</strong></p>

  <p>
    Scrapers that <strong>collect</strong> ·
    MCP servers that <strong>connect</strong> ·
    AI workflows that <strong>analyze</strong>
  </p>
...
`TypeScript` · `Python` · `Apify` · `Crawlee` · `Camoufox` · `Playwright` · `MCP SDK` · `Claude` · `Astro` · `FastAPI`
